...
public abstract class CustomClass {
	...
	protected static void detectPlatform() {
		final String os = NativeFileSystemConstants.OS;
	...
	protected static void setDefaultLookAndFeel() {
		try {
			UIManager.setLookAndFeel(LookAndFeelConstants.METAL);
			return;
	...
	protected static void setGtkLookAndFeel() {
		try {
			UIManager.setLookAndFeel(LookAndFeelConstants.GTK);
			return;
		} catch (ClassNotFoundException e) {
			return;
		} catch (InstantiationException e) {
	...
	protected static void setLinuxLookAndFeel() {
		try {
			UIManager.setLookAndFeel(LookAndFeelConstants.LINUX);
			return;
		} catch (ClassNotFoundException e) {
			return;
		} catch (InstantiationException e) {
	...
	protected static void setWindowsLookAndFeel() {
		try {
			UIManager.setLookAndFeel(LookAndFeelConstants.WIN);
			return;
		} catch (ClassNotFoundException e) {
			return;
		} catch (InstantiationException e) {
			...
			try {
				UIManager.setLookAndFeel(LookAndFeelConstants.WINCLASSIC);
				return;
			} catch (ClassNotFoundException e) {
				return;
			} catch (InstantiationException e) {
	...
	protected final static class LookAndFeelConstants {
	...
	protected final static class NativeFileSystemConstants {
